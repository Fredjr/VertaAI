          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <h3 className="text-sm font-medium text-yellow-800 dark:text-yellow-200">
                ⚠️ Legacy Page - Migrating to Unified Policy Packs
              </h3>
              <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                <p>
                  This page is deprecated. Please use the new{' '}
                  <a
                  ...
                  {' '}page which combines both Track A (Contracts) and Track B (Drift Plans) in a unified interface.
                </p>
              </div>
            </div>
          </div>
