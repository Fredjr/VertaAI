...
export enum FindingCode {
  ...
  // Cross-Artifact codes (Track A Task 2)
  OPENAPI_CODE_MISMATCH = 'OPENAPI_CODE_MISMATCH',
  CODE_OPENAPI_MISMATCH = 'CODE_OPENAPI_MISMATCH',
  SCHEMA_MIGRATION_MISSING = 'SCHEMA_MIGRATION_MISSING',
  MIGRATION_SCHEMA_MISMATCH = 'MIGRATION_SCHEMA_MISMATCH',
  CONTRACT_IMPLEMENTATION_MISMATCH = 'CONTRACT_IMPLEMENTATION_MISMATCH',
  IMPLEMENTATION_CONTRACT_MISMATCH = 'IMPLEMENTATION_CONTRACT_MISMATCH',
  DOC_CODE_MISMATCH = 'DOC_CODE_MISMATCH',
  CODE_DOC_OUTDATED = 'CODE_DOC_OUTDATED',
  TEST_IMPLEMENTATION_MISSING = 'TEST_IMPLEMENTATION_MISSING',
  IMPLEMENTATION_TEST_MISSING = 'IMPLEMENTATION_TEST_MISSING',

  // Agent Governance codes (Spec→Build→Run Triangle)
  // Spec→Build (Intent ↔ Capability Parity)
  INTENT_CAPABILITY_UNDECLARED = 'INTENT_CAPABILITY_UNDECLARED',
  INTENT_CAPABILITY_UNUSED = 'INTENT_CAPABILITY_UNUSED',
  INTENT_CONSTRAINT_VIOLATED = 'INTENT_CONSTRAINT_VIOLATED',
  INTENT_CAPABILITY_CONSISTENT = 'INTENT_CAPABILITY_CONSISTENT',
  // Build→Run (Infrastructure Ownership Parity)
  INFRA_OWNERSHIP_MISSING = 'INFRA_OWNERSHIP_MISSING',
  INFRA_OWNERSHIP_MISMATCH = 'INFRA_OWNERSHIP_MISMATCH',
  INFRA_OWNERSHIP_CONSISTENT = 'INFRA_OWNERSHIP_CONSISTENT',
  // Build→Run (Churn Complexity Risk)
  CHURN_COMPLEXITY_HIGH_RISK = 'CHURN_COMPLEXITY_HIGH_RISK',
  CHURN_COMPLEXITY_MEDIUM_RISK = 'CHURN_COMPLEXITY_MEDIUM_RISK',
  CHURN_COMPLEXITY_LOW_RISK = 'CHURN_COMPLEXITY_LOW_RISK',
  // Build→Run (Duplicate Abstraction Risk — spaghetti prevention)
  DUPLICATE_ABSTRACTION_RISK = 'DUPLICATE_ABSTRACTION_RISK',
  // Spec→Build (Over-permissioned Import — import requires undeclared capability)
  OVERPERMISSIONED_IMPORT = 'OVERPERMISSIONED_IMPORT',
  // Spec→Run (Intent ↔ Runtime Parity)
  INTENT_RUNTIME_UNDECLARED = 'INTENT_RUNTIME_UNDECLARED',
  INTENT_RUNTIME_UNUSED = 'INTENT_RUNTIME_UNUSED',
  INTENT_RUNTIME_CONSISTENT = 'INTENT_RUNTIME_CONSISTENT',
