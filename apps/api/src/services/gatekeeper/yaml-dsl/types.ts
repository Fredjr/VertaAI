...
export enum ComparatorId {
  ...
  OPENAPI_CODE_PARITY = 'OPENAPI_CODE_PARITY',
  SCHEMA_MIGRATION_PARITY = 'SCHEMA_MIGRATION_PARITY',
  CONTRACT_IMPLEMENTATION_PARITY = 'CONTRACT_IMPLEMENTATION_PARITY',
  DOC_CODE_PARITY = 'DOC_CODE_PARITY',
  TEST_IMPLEMENTATION_PARITY = 'TEST_IMPLEMENTATION_PARITY',

  // Cross-Artifact comparators (11.1 - Full Acceptance Criteria)
